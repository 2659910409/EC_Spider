...
class TestPageDataService(unittest.TestCase):
    ...
    def test_page_data(self):
        # 插入page数据并返回一个page对象
        page_param = ['直通车', '报表', 'https://subway.simba.taobao.com/#!/report/bpreport/index', '直通车报表', None]
        page_service = PageService()
        page = page_service.add_page(page_param[0], page_param[1], page_param[2], page_param[3], page_param[4])
