...
-- -----------------------------------------------------
-- Table `rpa_monitor`.`t_data_tab`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rpa_monitor`.`t_data_tab` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(64) NULL,
...
-- -----------------------------------------------------
-- Table `rpa_monitor`.`t_data_tab_column`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rpa_monitor`.`t_data_tab_column` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  `updated` TIMESTAMP NULL,
  PRIMARY KEY (`id`),
  INDEX `page_data_id0_idx` (`data_tab_id` ASC) VISIBLE,
